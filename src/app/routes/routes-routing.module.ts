     ...
     // { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
      {
        ...
        data: { title: 'logindashboard', titleI18n: 'dashboard' },
      },
      {
        path: 'dashboard',
      ...
      {
        path: 'drilling',
        loadChildren: () => import('./drilling/drilling.module').then(m => m.DrillingModule),
        data: { title: 'Drilling', titleI18n: 'drilling'}
      },
      {
        path: 'design',
